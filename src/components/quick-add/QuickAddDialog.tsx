...
import { Building2, CalendarIcon, CircleDot, User } from 'lucide-react';
import {
  Dialog,
  DialogContent,
  DialogFooter,
...
export function QuickAddDialog({ open, onOpenChange }: QuickAddDialogProps) {
  ...
  React.useEffect(() => {
    ...
    const anyOpen = boardDropdownOpen || assigneeDropdownOpen || dateDropdownOpen || statusDropdownOpen;
    if (anyOpen) {
      document.addEventListener('mousedown', handleClick);
      return () => document.removeEventListener('mousedown', handleClick);
    }
  }, [boardDropdownOpen, assigneeDropdownOpen, dateDropdownOpen, statusDropdownOpen]);
